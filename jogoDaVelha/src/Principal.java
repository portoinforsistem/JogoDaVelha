...
public class Principal {
    ...
    public static void main(String[] args) {
        //indica a posição onde se deseja jogar pelo numpad do teclado, os numeros de 1 a 9 representam a respectiva posição
        int jogada;
        ...
        while (jogo.terminado() == 0) { //variavel status do jogo, não é bool pois teoricamente há três possibilidades
            while (true) { //loop de repetição para jogadas do jogador
                //escolha da posição no tabuleiro
                jogada = Integer.parseInt(JOptionPane.showInputDialog("Digite um número de 1 a 9 para sua jogada:"));
                ...
                } catch (Exception e) { //caso o valor inserido não for um numero inteiro, positivo ou entre 1 e 9, etc
                    JOptionPane.showMessageDialog(null, "Opção inválida, tente novamente");
                }
            }
            ...
            if(jogo.terminado() != 0){ //quebra o ciclo caso o jogo tenha terminado
                break;
            }
        ...
        if (jogo.terminado() == 1) {
            System.out.println("\nO computador venceu.");
        } else if(jogo.terminado() == 3){ 
            System.out.println("\nO jogador venceu");
        }else if(jogo.terminado() == 2){ 
            System.out.println("\nEmpate");
        }
    }
       ...
       //percorre todos os indices da matriz com um loop dentro de outro
        for (int linhas = 0; linhas < 3; linhas++) {
            for (int colunas = 0; colunas < 3; colunas++) {
                System.out.print(mat[linhas][colunas] + " "); //espaçamento entre campos do tabuleiro
            }
